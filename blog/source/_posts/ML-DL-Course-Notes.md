...
| 2 | [经典机器学习算法](#ml-notes) | SVM、聚类、PCA、异常检测、推荐系统 |
| 3 | [神经网络基础](#dl-notes) | 向量化、前向/反向传播、初始化 |
| 4 | [深层网络训练](#dl-notes) | 正则化、优化器、BatchNorm、项目策略 |
| 5 | [计算机视觉](#dl-notes) | CNN、ResNet、Inception、目标检测、人脸与风格迁移 |
